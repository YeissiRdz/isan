<!DOCTYPE html>
<html lang="en">
<link rel="stylesheet" href="../styles_sp/preparatoria_abierta.css">
...
<body>
    ...
    <section class="first_section_niveles_educativos">
                <div class="first_section_niveles_educativos_img" style="background-image: url(../img_sp/preparatoria_abierta/portada.png);"></div>
                <div class="first_section_niveles_educativos_portada">
                    <h2 class="first_section_niveles_educativos_title">Preparatoria Abierta de ISAN</h2>
                    <p class="first_section_niveles_educativos_sibtitle">Estudiantes preparados
                    para abordar desafíos globales</p>
                </div>
    </section>
    ...
    <section class="second_section">
        <div class="second_section_grid">
            <div class="second_section_grid_info">
                <h2>Nuestros egresados han puesto en alto el nombre del colegio <strong>al ser reconocidos por las mejores universidades del mundo</strong></h2>
            </div>
            <div class="second_section_grid_img">
                <img src="../img_sp/preparatoria_abierta/seventh_section_preparatoria.png">
            </div>
        </div>
    </section>
    ...
    <section class="third_section">
        <div class="third_section_grid">
            <div class="third_section_grid_video">
                <video controls poster="../img_sp/preparatoria_abierta/third_section.png" class="third_section_grid_himno_video">
            ...
            <div class="third_section_grid_info">
                <p>En la Preparatoria ISAN queremos que cada estudiante elija su futuro, por eso ofrecemos la mejor educación a través de tres programas académicos:</p>
                <ul>
                    <li>Preparatoria Abierta ISAN</li>
                    <li>Licenciatura en Derecho</li>
                    <li>Licenciatura en Contaduría</li>
                </ul>

                <p>Nuestro objetivo es que los estudiantes alcancen los mejores resultados académicos, ya que nuestros programas están diseñados para brindar una formación integral y competitiva, con la posibilidad de acceder a maestrías y convenios con universidades nacionales e internacionales.</p>
            </div>
        </div>
    </section>
    ...
    <section class="sixth_section">
        <div class="sixth_section_grid">
            <div class="sixth_section_grid_video">
                <video controls poster="../img_sp/preparatoria_abierta/sixth_section_poster.png" class="third_section_grid_himno_video">
                    <source src="../img_sp/modelo_educativo/third_section_video.mp4" type="video/mp4">
                    Tu navegador no soporta la reproducción de video. Por favor, actualiza tu navegador.
                </video>
            </div>
            <div class="sixth_section_grid_info">
                <h2>Nuestros estudiantes se vuelven ciudadanos del mundo</h2>
                <p>En el Colegio ISAN, nuestros programas educativos no solo ofrecen una experiencia académica, sino que buscan formar estudiantes preparados para enfrentar los retos de un mundo globalizado.</p>
                <p>Nuestros alumnos desarrollan la capacidad de comprender el impacto de sus acciones mientras crecen en los ámbitos físico, intelectual, emocional y ético, convirtiéndose en profesionales integrales y ciudadanos responsables.</p>
            </div>
        </div>
    </section>

    <section class="seventh_section">
        <h2>Nuestros estudiantes desarrollan <strong>habilidades para la vida a través de un enfoque educativo integral.</strong></h2>
        <div class="seventh_section_grid">
            ...
            <div class="seventh_section_grid_video">
                <video controls poster="../img_sp/preparatoria_abierta/seventh_section_video.png" class="third_section_grid_himno_video">
                    <source src="../img_sp/modelo_educativo/third_section_video.mp4" type="video/mp4">
                    Tu navegador no soporta la reproducción de video. Por favor, actualiza tu navegador.
                </video>
            </div>
