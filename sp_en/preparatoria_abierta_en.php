...
<body>
    ...
    <section class="first_section_niveles_educativos">
                ...
                <div class="first_section_niveles_educativos_portada">
                    <h2 class="first_section_niveles_educativos_title">ISAN Open High School</h2>
                    <p class="first_section_niveles_educativos_sibtitle">Students prepared
    ...
    <section class="second_section">
        <div class="second_section_grid">
            <div class="second_section_grid_info">
                <h2>Our graduates have put the school's name on a high level <strong>by being recognized by the best universities in the world</strong></h2>
            </div>
    ...
    <section class="third_section">
        <div class="third_section_grid">
            ...
            <div class="third_section_grid_info">
                <p>At ISAN High School we want each student to choose his or her future, that is why we offer the best education through three academic programs:</p>
                <ul>
                    <li>ISAN Open High School</li>
                    <li>Law Degree</li>
                    <li>Bachelor's Degree in Accounting</li>
                </ul>

                <p>Our goal is that students achieve the best academic results, since our programs are designed to provide a comprehensive and competitive training, with the possibility of access to master's degrees and agreements with national and international universities.</p>
            </div>
        </div>
    </section>
    ...
    <section class="fifth_section">
        <div class="fifth_section_grid">
            ...
            <div class="fifth_section_grid_info">
                ...
                <p><strong>Extended hours:</strong> 3:00 pm a 4:30 pm</p>
            </div>
    ...
    <section class="sixth_section">
        <div class="sixth_section_grid">
            ...
            <div class="sixth_section_grid_info">
                <h2>Our students become citizens of the world</h2>
                <p>At Colegio ISAN, our educational programs not only offer an academic experience, but also seek to form students prepared to face the challenges of a globalized world.</p>
                <p>Our students develop the ability to understand the impact of their actions as they grow physically, intellectually, emotionally and ethically, becoming well-rounded professionals and responsible citizens.</p>
            </div>
        </div>
    </section>

    <section class="seventh_section">
        <h2>Our students develop <strong>life skills through a comprehensive educational approach.</strong></h2>
            ...
            <div class="ninth_section_img">
                ...
                <div class="ninth_section_content">
                    <div class="ninth_section_content_1">
                        <h2>Admissions</h2>
                        <p>Start the admission process to ISAN and learn more about the:</p>
                        <ul>
